...
// Input and validate data from user using the ValidateInput class. 3 import java.util.Scanner;
...
else if (!ValidateInput.validateZip(zip))           System.out.println("Invalid zip code");
else if (!ValidateInput.validatePhone(phone))       System.out.println("Invalid phone number");
